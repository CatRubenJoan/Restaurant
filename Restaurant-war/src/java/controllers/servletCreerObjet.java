...
public class servletCreerObjet extends HttpServlet {
    CommandeEnCoursLocal commandeEnCours = lookupCommandeEnCoursLocal();
    ...
    private CommandeEnCoursLocal lookupCommandeEnCoursLocal() {
        try {
            Context c = new InitialContext();
            return (CommandeEnCoursLocal) c.lookup("java:global/Restaurant/Restaurant-ejb/CommandeEnCours!beanSession.CommandeEnCoursLocal");
